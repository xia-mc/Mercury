 ...
 */
public final class ShardedSLRUCache<K, V> {
    private final Object2ObjectLinkedOpenHashMap<K, V> probation;
    private final Object2ObjectLinkedOpenHashMap<K, V> protectedMap;
    private final int probationCap;
    private final int protectedCap;

    public ShardedSLRUCache(int totalCapacity, int probationFractionPercent) {
        ...
        this.probation = new Object2ObjectLinkedOpenHashMap<>(initProb);
        this.protectedMap = new Object2ObjectLinkedOpenHashMap<>(initProt);
    }
